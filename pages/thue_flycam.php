...
<div class="filter-container">
  <div class="filter-row">
    <select>
      <option>Thuê Flycam / Gopro</option>
    </select>
    <select>
...
<?php
// Query products
$sql = "SELECT * FROM products WHERE category = 'Flycam'";
...
if ($result && $result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        $brand_img = ""; 
        if($brand == 'dji') $brand_img = "../assets/images/logo/dji.png";
        elseif($brand == 'gopro') $brand_img = "../assets/images/logo/gopro.png"; // Cần file thực tế
    ...
    echo '<p style="padding: 20px; text-align: center; width: 100%;">Hiện chưa có sản phẩm Flycam/Gopro nào.</p>';
}
?>
</div>
