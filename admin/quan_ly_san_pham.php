        ...
        <tbody>
            <?php if ($result && $result->num_rows > 0): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="../pages/chi_tiet_san_pham.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm" target="_blank" title="Xem chi tiết">
...
<div id="productModal" class="modal">
    <div class="modal-content">
        ...
        <form action="../actions/xu_ly_san_pham.php" method="POST" enctype="multipart/form-data">
...
<form id="deleteForm" action="../actions/xu_ly_san_pham.php" method="POST" style="display:none;">
